      ...
      <Dialog as="div" className="relative z-100" onClose={onCloseModal}>
        ...
        <div className="fixed inset-0 overflow-y-auto">
          <div className="flex min-h-full w-full items-center justify-center p-4 text-center">
            ...
            >
              <Dialog.Panel className="bg-black-default fixed top-0 bottom-0 left-0 right-0 bg-shark-970 w-full max-h-screen transform p-6 text-left align-middle shadow-xl transition-all">
                {closable && (
                  <div
                    className={cn(
                ...
                <div className="flex flex-col grow h-full overflow-y-auto mt-8 z-50">
