...
const Modal = ({
  ...
  return (
    <Transition appear show={isOpen} as={Fragment}>
      <Dialog as="div" className="relative z-[110]" onClose={onCloseModal}>
        <Transition.Child
          as={Fragment}
          ...
          leaveTo="opacity-0"
        >
          <div className="fixed inset-0 bg-black bg-opacity-25 z-[110]" />
        </Transition.Child>
        ...
        >
          <div className="flex min-h-full w-full items-center justify-center p-4 text-center">
            ...
            >
              <Dialog.Panel className="bg-black-default fixed top-0 bottom-0 left-0 right-0 bg-shark-970 w-full max-h-screen transform py-6 px-4 text-left align-middle shadow-xl transition-all">
                {closable && (
                  <div
                    className={cn(
